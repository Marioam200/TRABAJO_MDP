...
El AFC es un método descriptivo que nos permite analizar las relaciones entre las variables categóricas presentes en nuestra base de datos, representándolas en un espacio más reducido.

Para aplicar el AFC Simple, es necesario contar con 2 factores que presenten un elevado número de categorías, lo que no se da en nuestro caso.

Es por ello que optamos por aplicar el AFC múltiple sobre las 4 variables categóricas con las que contamos: 

- hardness: codificada en una escala ordinal tipo Mohs, donde 1 indica menor dureza y 7 mayor dureza.
- color: color del cristal (CL: transparente; WH: blanco; OT: otros colores).
- transparency: nivel de transparencia del cristal (TP: transparente; TL: translúcido; OP: opaco).
